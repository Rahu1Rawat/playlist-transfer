...
function SelectPlaylistsPage() {
    ...
    const handleLoadPlaylistsClick = () => {
        navigate("/move-playlists");
    };
    ...
    return (
        <div>
            ...
            <div className="bg-customBlue min-h-screen text-white flex flex-col items-center gap-9">
                ...
                <div>
                    <p className="font-semibold">STEP 2/4</p> {/* Hardcoded */}
                </div>
                <div className="flex flex-col gap-8 rounded-3xl bg-logoBarBlue p-10">
                    <div className="flex justify-center">
                        <div className="pt-6">
                            <p className="text-4xl font-bold">Spotify Playlist</p> {/* Hardcoded */}
                        </div>
                    </div>
                    <div className="flex items-center gap-x-6">
                        <div>
                            <button
                                className="bg-buttonBlue w-64 h-14 text-white rounded-full"
                                onClick={handleLoadPlaylistsClick}
                            >
                        ...
                        <div className="flex flex-col gap-8">
                            ...
                            <div>
                                <button className="bg-buttonBlue w-96 h-14 text-white rounded-full">
                                    Load from URL
                                </button>
                            </div>
                        </div>
